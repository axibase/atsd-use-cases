...
**Repository**, **User**, and **Issue** redirect you to the repository where the issue is raised, the user who raised the issue, and the issue page itself, respectively.
