...
the CPI see the following [analysis](/../master/CBI_CPI/README.md) that track how CPI affected the value of the Israeli Shekel over several
decades.
...
[here](/../master/Support/Moving-Avg/README.md).
