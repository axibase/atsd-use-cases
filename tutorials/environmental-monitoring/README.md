...
* [Basic Singular Spectrum Analysis and Forecasting with R, Computational Statistics and Data Analysis, Volume 71, March 2014, Pages 934-954](resources/1206.6910v2.pdf)
...
> Eigen values, Eigenvectors, pairs of sequential Eigen vectors, and `w`-correlation matrix of the decomposition are graphed.
...
Three different options `– 1`, `1:23`, and `1:35` are tested because groups `1`, `2:23`, and `24:35` are separated from other Eigen vectors, as judged from the `w`-correlation matrix.
