...
In a local instance of ATSD open the **Data > CSV Parsers** page, scroll to the bottom of the page, expand the split-button, and click **Create**. Copy the schema showed below to **Schema**.
