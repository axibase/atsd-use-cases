...
This section of the article discusses the underlying settings used for the chart above. For introductory information on using **Trends**, see this [guide](../../integration/shared/trends.md).
