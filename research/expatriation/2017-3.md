...
[![](../images/new-button.png)](https://apps.axibase.com/chartlab/61a855b0/3/#fullscreen)

*Fig 1.* The top chart uses a [`time-offset`](https://axibase.com/docs/charts/widgets/time-chart/) setting to show a quarter-on-quarter comparison, while the annual totals are shown in the bottom chart.
...
Customized data monitoring in ATSD is possible using [`alert-expressions`](https://axibase.com/docs/charts/syntax/alert-expression.html#alert-expressions) whereby user-specified parameters may be defined to trigger alarms based on incoming data.
...
[![](../images/new-button.png)](https://apps.axibase.com/chartlab/95617f2b)
