...
and subsequently denied an offer to serve as an Associate Justice on the Supreme Court of the United States a few years later.
...
and complicated process, one of the main features of which is settling up with the Internal Revenue Service
 via the eponymous Expatriation Tax: `https://www.irs.gov/individuals/international-taxpayers/expatriation-tax`.
...
To give the issue further context, the table and visualization above use the most current Naturalization data from the Department of Homeland Security (DHS) data available at `https://www.uscis.gov/news/fact-sheets/naturalization-fact-sheet`.

Naturalization is the sister process to expatriation,
...
concerning the most common first names chosen throughout the last century and United States Census data from `https://www.census.gov/main/www/cen2000.html`,
...
>Only the name Smith appears on the list of most common American last names: `https://www.census.gov/main/www/cen2000.html`
