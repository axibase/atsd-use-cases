...
and complicated process, one of the main features of which is settling up with the Internal Revenue Service
 via the eponymous Expatriation Tax.
...
To give the issue further context, the table and visualization above use the most current Naturalization data from the [Department of Homeland Security data](https://www.uscis.gov/news/fact-sheets/naturalization-fact-sheet).
...
concerning the most common first names chosen throughout the last century and [United States Census data](https://www.census.gov/main/www/cen2000.html) concerning the most common last names to compare, the following queries and visualizations show
