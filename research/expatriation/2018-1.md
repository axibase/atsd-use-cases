...
Additionally, a [`SUM`](https://axibase.com/docs/charts/syntax/value_functions.html#statistical-functions) value function may be applied to aggregate quarterly samples into annual totals for the defined `period`.
