# Tax Day 2017: Taxpayers of the Nation Procrastinate
...
**Source**: IRS Filing Season Statistics `https://www.irs.gov/uac/2017-and-prior-year-filing-season-statistics`

![](./images/total_receipts.png)

[![View in ChartLab](../images/new-button.png)](https://apps.axibase.com/chartlab/626f6fb9/3/#fullscreen)

One of the possible reasons is refund delays introduced by the [Protecting Americans From Tax Hikes Act of 2015](https://www.irs.gov/uac/newsroom/path-act-tax-related-provisions). While some news reports have speculated that the slack is caused by the misguided expectations of a possible [tax relief](https://www.reuters.com/article/us-money-taxes-delays-idUSKBN16L18C) in the aftermath of the 2017 presidential election, the PATH Act appears to be the most credible explanation for the drop in filings. The Act mandates the IRS to put a hold on refunds claiming the Earned Income Tax Credit or the Additional Child Tax Credit until mid-February. It removes incentives for the early filers to submit the returns as soon as possible. To its credit the PATH act attempts to fight a major loophole that allowed identity fraudsters to submit **5 million** fake returns and steal **[$30 billion](https://www.justice.gov/tax/stolen-identity-refund-fraud)** from tax payers in 2013 of which only **$24 billion** was recovered.
...
These dates are Fridays when the metrics are collected and as such they ignore `day-of-week` and Tax Day changes between the annual periods. In the [IRS example](https://www.irs.gov/uac/newsroom/filing-season-statistics-for-week-ending-march-31-2017), `2017-Mar-31` is the ninetieth day in the year whereas `2016-Apr-01` is the ninety second day of the year. `2017-Mar-31` is 18 days away from the Tax Day, whereas `2016-Apr-01` is 17 days from the Tax Day.

Build year-on-year comparisons for the following three scenarios:

* Case 1. Tax payers file returns on the same calendar date each year, March 31 is compared with March 31. After many years of doing it, people might have a marker in their calendar to do it on April 10, for example.
* Case 2. Tax payers file returns on the same ordinal day in each year, for example on the ninetieth day. It takes time to gather forms and receipts from employers, banks, brokers, and this effort takes certain amount of time each year. Assume this is a constant number.
* Case 3. Tax payers file returns based on the deadline, for example when ten days are remaining to Tax Day. Historically, it has been April 15, however with the introduction of the Emancipation Day in Washington, D.C, the specific Tax Day changes more often going forward.
...
[![View in ChartLab](../images/new-button.png)](https://apps.axibase.com/chartlab/fc79b852/2/#fullscreen)
...
* Reuters: "[U.S. taxpayers procrastinate on filing returns this year](https://www.reuters.com/article/us-money-taxes-delays-idUSKBN16L18C)"
* Time: "[Fewer Americans Are Filing Their Tax Returns This Year Than in 2016](https://time.com/money/4697931/fewer-americans-filing-tax-returns/)"