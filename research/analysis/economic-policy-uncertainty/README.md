...
* Download this [parser job file](resources/csv-parser-epu-demo.xml) which contains the settings that you can use to configure the CSV Document parser in the ATSD interface. Use the [Import Walkthrough](../../../integration/shared/import-csv-parser.md) for help uploading the XML file to ATSD.