...
of the top or bottom fifteen stations, the top or bottom fifty stations, or select the [wildcard](https://axibase.com/docs/charts/syntax/wildcards.html#wildcards) (`*`)
