...
Here is a link to our article on [Hawaii gas prices](../hawaii-prices/README.md). The [action items](../hawaii-prices/README.md#action-items) in that article show the steps for installing ATSD.
