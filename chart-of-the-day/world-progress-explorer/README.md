...
[Axibase Charts](https://axibase.com/docs/charts/) uses a simple syntax to perform advanced calculations on the client. The underlying mechanics of the `PercentChangeFromYearAgo` function are shown here:
...
Although a non-relational database, ATSD supports an SQL-like feature called [SQL Console](https://axibase.com/docs/atsd/sql/), a convenient interface which allows users quickly query data.
